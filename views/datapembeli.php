...
$objPembeli=new modelPembeli();
$objPembeli->select();
$datapembeli=$objPembeli->getData();
foreach ($datapembeli as $key) 
{
?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-social-icon" title="Edit"><i class="fa fa-edit" data-toggle="modal" href="#mymodal<?php echo $key['ID_PEMBELI']; ?>"></i></a>
                    <a class="btn btn-social-icon" title="Detail"><i class="fa fa-user"></i></a>
                    <a class="btn btn-social-icon" title="Delete" href="../proses/prosesPembeli.php?aksi=hapus&namapembeli=<?php echo $key['ID_PEMBELI']; ?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
        <div class="modal fade" id="mymodal<?php echo $key['ID_PEMBELI']; ?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Update Data Pembeli</h4>
              </div>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="../proses/prosesPembeli.php?aksi=edit" method="post">
                  <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Id Pembeli</label>
                    <input type="input" class="form-control" id="idPembeli" name="idPembeli" value="<?php echo $key['ID_PEMBELI']; ?>" readonly>
                  </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">NO HP</label>
                    <input type="input" class="form-control" id="nomer" name="nomer" value="<?php echo $key['NO_HP']; ?>">
                  </div>
                </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Registrasi Pembeli</h4>
              </div>
              <div class="modal-body">
                <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="../proses/prosesPembeli.php?aksi=tambah" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">No</label>

                  <div class="col-sm-10">
                    <input type="input" class="form-control" id="inputIdPembeli" name="inputIdPembeli">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Username</label>
